...
[%collapsible]
====
Which stage best matches each statement?

. Developers own both application code and infrastructure.
. Platform teams provide Golden Paths and self-service capabilities.
. Operations teams provision infrastructure for every application.
. AI assistants begin interacting directly with the platform.
